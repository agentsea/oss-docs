...
- A valid email address
- A credit card for billing (GCP offers a free tier and $300 in free credits for new users)
- **CRITICAL NOTE** - You will need to activate your free credits by choosing the blue "Activate" button at the top right of the screen in order to be able to create a Kubernetes cluster, which requires 900 GB of SSD storage by default and trial accounts come with only 500 GBs.
