...
Now you are ready to create a VM for an agent to use with the following command:
...
Now you can turn to our [Quickstart](https://docs.hub.agentsea.ai/quickstart) to launch your first agent.
