...
The main goal of this system is to keep track of your agent tasks and logs of there execution. 
`SurfKit` uses `Taskara` under the hood to create and assign tasks, while the agents themselves 
use it to record the log and report the completion or failure. 
