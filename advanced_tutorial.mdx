---
title: (REVIEW) Building Your Agent from Scratch
...
for `image.py` [here](https://github.com/agentsea/surfhamster/blob/4a80d5f1fab16d61a0669ffca1507f6768c2b8dd/surfhamster/image.py).
