...
```python
{
  ...
  "reason": "To search for a cool cat image, the next step is to type the search query into the Google search box 
...
and also convert images to and from b64 because it's the only format of the image that gpt-4o accepts.
